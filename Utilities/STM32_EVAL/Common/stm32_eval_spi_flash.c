...
void sFLASH_WriteBuffer(uint8_t* pBuffer, uint32_t WriteAddr, uint16_t NumByteToWrite)
{
	...
	Addr = WriteAddr % sFLASH_SPI_PAGESIZE;						// Offset in the Page
	count = sFLASH_SPI_PAGESIZE - Addr;							// Byte Number to be written in a Page
	NumOfPage =  NumByteToWrite / sFLASH_SPI_PAGESIZE;			// Page Number to be written
	NumOfSingle = NumByteToWrite % sFLASH_SPI_PAGESIZE;			// Byte Number to be written not enough a Page
	...
	else /*!< WriteAddr is not sFLASH_PAGESIZE aligned  */
	{
		...
		{
			/*!	1. Write data not enough a page
				2. Write the rest data which is address aligned */
